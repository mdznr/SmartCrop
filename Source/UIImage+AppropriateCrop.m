...
- (CGRect)appropriateCropRegionForCropSize:(CGSize)cropSize
{
	...
	CGAspectRatioRelation shiftRelation = CGAspectRatioRelationForAspectRatio( CGAspectRatioMakeWithSize(CGSizeMake(cropSize.height, cropSize.width)) );
	
	// No real relation for squares, use image relation.
	if ( shiftRelation == CGAspectRatioRelationSquare ) {
		shiftRelation = CGAspectRatioRelationForAspectRatio( CGAspectRatioMakeWithSize(self.size) );
